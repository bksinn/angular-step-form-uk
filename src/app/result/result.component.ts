...
export class ResultComponent implements OnInit {
    ...
    goToPrevious(form: any) {
        ...
        if (this.save(form)) {
            ...
            document.getElementById('four').classList.remove('completed-tabs')
    ...
    processFormData() {
        let applicationData = {
            ...
            "Application": {
                ...
                "EmployerName": this.formData.employerName.length ? this.formData.employerName : "Unemployed",
                "JobTitle": this.formData.jobTitle.length ? this.formData.jobTitle : "Unemployed",
